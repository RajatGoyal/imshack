package com.yourpalmark.chat
{
	...
	public class ChatManager extends EventDispatcher
	{
		...
		{
			FlexGlobals.topLevelApplication.addElement(FlexGlobals.topLevelApplication.loading);
...
//		}
		...
		protected function onRosterLoaded( event:RosterEvent ):void
		{
			...
			dispatchEvent( event );
			FlexGlobals.topLevelApplication.callLater(hideloading);
		}
		
		protected function hideloading():void{
			FlexGlobals.topLevelApplication.removeElement(FlexGlobals.topLevelApplication.loading);
